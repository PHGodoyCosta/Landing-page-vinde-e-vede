...
<head>
    ...
    <title>Vinde e Vede 2025 | Inscrições Abertas - Seminário São Vicente Pallotti</title>
    <meta name="description" content="Participe do Vinde e Vede 2025! Jovens são convidados a viver dias de fé, amizade e descoberta no Seminário São Vicente Pallotti. Inscreva-se já!">
    <meta property="og:title" content="Vinde e Vede 2025 - Inscreva-se já!" />
...
<body>
    <header class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Vinde e Vede</span>
            </a>
            ...
            <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                <a href="#" class="block py-2 px-3 rounded-sm md:bg-transparent md:p-0 dark:text-white" aria-current="page">Início</a>
                </li>
                <li>
                <a href="#video" class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Vídeo</a>
                </li>
                <li>
                <a href="#inscricao" class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Inscrição</a>
                </li>
                <li>
                <a href="#whatsapp" class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Whatsapp</a>
                </li>
                <li>
                <a href="#perguntas" class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Perguntas Frequentes</a>
                </li>
            </ul>
            </div>
        </div>
    ...
    <main>
        <div class="flex w-full overflow-x-hidden h-auto lg:h-[calc(100vh - 72px)] justify-center" style="background-color: rgb(34, 34, 34)">
            <div id="controls-carousel" data-carousel="slide" class="relative" data-carousel="static">
                <div class="absolute top-7 left-1/2 transform -translate-x-1/2 z-40 text-center drop-shadow-lg font-[Montserrat] text-bold rop-shadow-lg px-4 py-2 rounded-lg w-9/10 md:w-auto pb-4">
                    ...
                    <a href="#inscricao" class="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 rounded-lg text-2xl lg:text-3xl px-5 py-2.5 text-center mb-2 font-bold shadow-lg">
        ...
        <div id="video">
            ...
            <div class="w-full mt-4 flex justify-center">
                ...
                <video class="h-200 rounded-[10px]" controls>
        ...
        <div id="whatsapp">
            <div class="flex w-full justify-center">
                <img src="/images/pallotti_whatsapp.png" alt="Foto ilustrativa de Pallotti com Jovens para chamar ao grupo do whatsapp">
            </div>
            <h2 class="text-3xl md:text-4xl text-center mt-5 font-[Poppins] font-bold">Entre no nosso grupo do Whatsapp!</h2>
            <div class="mt-5 pb-2 flex justify-center">
                <a href="https://chat.whatsapp.com/CFb1IS1ObZQ8tRAoMFbBwr?mode=ems_wa_c" target="_blank" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-xl px-5 py-2.5 text-center me-2 mb-2 font-[Poppins] flex gap-2 items-center">
                    <img src="/images/icons8-whatsapp-50.png" alt="Icon do Whatsapp" class="w-7">
                    <span>Grupo do Whatsapp</span>
                </a>
            </div>
        </div>
        <div id="perguntas" class="mt-3 pt-1" style="background-color: #e6e6e6;">
            <h1 class="text-4xl text-center mt-5 font-[Poppins] font-bold">Perguntas Frequentes</h1>

            <div class="flex justify-center">
                <div id="accordion-collapse" data-accordion="collapse" class="mt-5 mb-3 max-w-9/10 md:max-w-8/10 font-[Poppins] rounded-[10px]" style="background-color: white;">
                    ...
                    <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
                        ...
                        <p class="mb-2 text-gray-500 dark:text-gray-400">Um encontro de jovens que sentem uma inquietação vocacional e desejam fazer uma experiência para conhecer o Seminário São Vicente Pallotti em Palotina/PR.</p>
                        </div>
                    </div>
                    ...
                    <div id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
                        ...
                        <p class="mb-2 text-gray-500 dark:text-gray-400">Em Palotina/PR no Seminário São Vicente Pallotti, no dia 26, 27 e 28 de setembro de 2025.</p>
                        </div>
                    </div>
    ...
    <footer class="bg-white rounded-lg shadow-sm dark:bg-gray-900">
        <div class="w-full max-w-screen-xl mx-auto p-4">
            ...
            <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" class="hover:underline">Seminário São Vicente Pallotti™</a>. Todos os direitos reservados.</span>
        </div>
    </footer>
